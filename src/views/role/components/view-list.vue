...
const emit = defineEmits<{
  ...
  // (e: 'sort-change'): void
  (e: 'toggle-enabled', row: RoleItem, val: boolean): void
  (e: 'delete-row', row: RoleItem): void
}>()
</script>

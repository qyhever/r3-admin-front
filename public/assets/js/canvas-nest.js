          ...
          value: function () {
            ...
            ;(d(this.el, function () {
              ...
              (window.onmousemove = function (t) {
                ;((e.current.x =
                  t.clientX - e.el.offsetLeft + document.scrollingElement.scrollLeft),
            ...
            ;(r.forEach(function (r, f) {
              for (
                ...
                null !== (s = a[u]).x &&
                  ...
                  (d = r.y - s.y),
                  (v = l * l + d * d) < s.max &&
                    (s === i && v >= s.max / 2 && ((r.x -= 0.03 * l), (r.y -= 0.03 * d)),
                    (c = (s.max - v) / s.max),
                    t.beginPath(),
                    (t.lineWidth = c / 2),
                    (t.strokeStyle = 'rgba(' + e.c.color + ',' + (c + 0.2) + ')'),
                    t.moveTo(r.x, r.y),
                    t.lineTo(s.x, s.y),
                    t.stroke()))
            }),
